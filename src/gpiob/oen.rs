...
#[doc = "Field `IOXOEN` reader - Each bit controls the IOX output enable signal."]
pub type IOXOEN_R = crate::FieldReader<u16, u16>;
#[doc = "Field `IOXOEN` writer - Each bit controls the IOX output enable signal."]
pub type IOXOEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OEN_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Each bit controls the IOX output enable signal."]
    #[inline(always)]
    pub fn ioxoen(&self) -> IOXOEN_R {
        IOXOEN_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Each bit controls the IOX output enable signal."]
    #[inline(always)]
    #[must_use]
    pub fn ioxoen(&mut self) -> IOXOEN_W<0> {
        IOXOEN_W::new(self)
    }
