...
#[doc = "Field `IOXDAT` reader - Each bit controls the IOX output data and pull low/high function."]
pub type IOXDAT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `IOXDAT` writer - Each bit controls the IOX output data and pull low/high function."]
pub type IOXDAT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DAT_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Each bit controls the IOX output data and pull low/high function."]
    #[inline(always)]
    pub fn ioxdat(&self) -> IOXDAT_R {
        IOXDAT_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Each bit controls the IOX output data and pull low/high function."]
    #[inline(always)]
    #[must_use]
    pub fn ioxdat(&mut self) -> IOXDAT_W<0> {
        IOXDAT_W::new(self)
    }
