...
#[doc = "Field `INTSTS` reader - Timer x interrupt status register."]
pub type INTSTS_R = crate::BitReader<bool>;
#[doc = "Field `INTSTS` writer - Timer x interrupt status register."]
pub type INTSTS_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, INTSTS_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Timer x interrupt status register."]
    #[inline(always)]
    pub fn intsts(&self) -> INTSTS_R {
        INTSTS_R::new((self.bits & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Timer x interrupt status register."]
