...
#[doc = "Field `VALUE` reader - Timer x current value register."]
pub type VALUE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `VALUE` writer - Timer x current value register."]
pub type VALUE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, VALUE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - Timer x current value register."]
    #[inline(always)]
