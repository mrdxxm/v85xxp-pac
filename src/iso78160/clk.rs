...
#[doc = "Field `CLKDIV` reader - The ISO7816 clock divider ratio."]
pub type CLKDIV_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CLKDIV` writer - The ISO7816 clock divider ratio."]
pub type CLKDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLK_SPEC, u8, u8, 7, O>;
#[doc = "Field `CLKEN` reader - ISO7816 clock output enable."]
pub type CLKEN_R = crate::BitReader<bool>;
#[doc = "Field `CLKEN` writer - ISO7816 clock output enable."]
pub type CLKEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:6 - The ISO7816 clock divider ratio."]
    #[inline(always)]
    pub fn clkdiv(&self) -> CLKDIV_R {
        CLKDIV_R::new((self.bits & 0x7f) as u8)
    }
    #[doc = "Bit 7 - ISO7816 clock output enable."]
    #[inline(always)]
    pub fn clken(&self) -> CLKEN_R {
        CLKEN_R::new(((self.bits >> 7) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:6 - The ISO7816 clock divider ratio."]
    ...
    #[inline(always)]
    #[must_use]
    pub fn clken(&mut self) -> CLKEN_W<7> {
        CLKEN_W::new(self)
    }
