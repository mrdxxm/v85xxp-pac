...
#[doc = "Field `DATA` reader - Read: Receive data. Write: Transmit data."]
pub type DATA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DATA` writer - Read: Receive data. Write: Transmit data."]
pub type DATA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DATA_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - Read: Receive data. Write: Transmit data."]
    #[inline(always)]
