...
pub type BAUDDIV_R = crate::FieldReader<u16, u16>;
#[doc = "Field `BAUDDIV` writer - Baud rate divider register."]
pub type BAUDDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, BAUDDIV_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Baud rate divider register."]
    #[inline(always)]
    pub fn bauddiv(&self) -> BAUDDIV_R {
        BAUDDIV_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Baud rate divider register."]
...
#[doc = "`reset()` method sets BAUDDIV to value 0x4b00"]
impl crate::Resettable for BAUDDIV_SPEC {
    const RESET_VALUE: Self::Ux = 0x4b00;
}
