...
#[doc = "Field `IOADAT` reader - Each bit control the IOA output data and pull low/high function."]
pub type IOADAT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `IOADAT` writer - Each bit control the IOA output data and pull low/high function."]
pub type IOADAT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DAT_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Each bit control the IOA output data and pull low/high function."]
    #[inline(always)]
    pub fn ioadat(&self) -> IOADAT_R {
        IOADAT_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Each bit control the IOA output data and pull low/high function."]
    #[inline(always)]
    #[must_use]
    pub fn ioadat(&mut self) -> IOADAT_W<0> {
        IOADAT_W::new(self)
    }
