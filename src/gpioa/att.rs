...
#[doc = "Field `IOAATT` reader - Each bit control the IOA attribute."]
pub type IOAATT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `IOAATT` writer - Each bit control the IOA attribute."]
pub type IOAATT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ATT_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Each bit control the IOA attribute."]
    #[inline(always)]
    pub fn ioaatt(&self) -> IOAATT_R {
        IOAATT_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Each bit control the IOA attribute."]
    #[inline(always)]
    #[must_use]
    pub fn ioaatt(&mut self) -> IOAATT_W<0> {
        IOAATT_W::new(self)
    }
