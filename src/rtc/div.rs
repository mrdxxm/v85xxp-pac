...
#[doc = "Field `RTCDIV` reader - This register is used to configurates RTCPLLDIV output frequency."]
pub type RTCDIV_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RTCDIV` writer - This register is used to configurates RTCPLLDIV output frequency."]
pub type RTCDIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DIV_SPEC, u32, u32, 26, O>;
impl R {
    #[doc = "Bits 0:25 - This register is used to configurates RTCPLLDIV output frequency."]
    #[inline(always)]
    pub fn rtcdiv(&self) -> RTCDIV_R {
        RTCDIV_R::new(self.bits & 0x03ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:25 - This register is used to configurates RTCPLLDIV output frequency."]
